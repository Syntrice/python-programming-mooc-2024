...
class GameApplication:
    ...
    def create_objects(self) -> None:
        ...
        self.player1 = Player(self.game_images["robot"], x = 50, y = WINDOOW_HEIGHT // 2, speed=5)
        self.player2 = Player(self.game_images["robot"], x = 540, y = WINDOOW_HEIGHT // 2, speed=5)
            ...
            match event.type:
                ...
                case pygame.KEYDOWN:
                    match event.key:
                        ...
                        case pygame.K_a:
                            self.player1.x_vel = -1 * self.player1.speed
                        case pygame.K_d:
                            self.player1.x_vel = 1 * self.player1.speed
                        case pygame.K_w:
                            self.player1.y_vel = -1 * self.player1.speed
                        case pygame.K_s:
                            self.player1.y_vel = 1 * self.player1.speed
                        
                        case pygame.K_LEFT:
                            self.player2.x_vel = -1 * self.player2.speed
                        case pygame.K_RIGHT:
                            self.player2.x_vel = 1 * self.player2.speed
                        case pygame.K_UP:
                            self.player2.y_vel = -1 * self.player2.speed
                        case pygame.K_DOWN:
                            self.player2.y_vel = 1 * self.player2.speed
                ...
                case pygame.KEYUP:
                    match event.key:
                        case pygame.K_a:
                            self.player1.x_vel = 0
                        case pygame.K_d:
                            self.player1.x_vel = 0
                        case pygame.K_w:
                            self.player1.y_vel = 0
                        case pygame.K_s:
                            self.player1.y_vel = 0
                            
                        case pygame.K_LEFT:
                            self.player2.x_vel = 0
                        case pygame.K_RIGHT:
                            self.player2.x_vel = 0
                        case pygame.K_UP:
                            self.player2.y_vel = 0
                        case pygame.K_DOWN:
                            self.player2.y_vel = 0
